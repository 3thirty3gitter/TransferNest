import { columnPackNarrow, type ManagedImage } from './src/lib/column-packing';
...
console.log(`\nTesting column packing with ${designs.length} designs...\n`);
...
// Test 13" sheet
console.log('=== 13" SHEET (Column Packing) ===');
const result13 = columnPackNarrow(designs, 13, 0.05, canRotate);
...
console.log('\n=== 13" SHEET (Column Packing, 0.03" padding) ===');
const result13tight = columnPackNarrow(designs, 13, 0.03, canRotate);
